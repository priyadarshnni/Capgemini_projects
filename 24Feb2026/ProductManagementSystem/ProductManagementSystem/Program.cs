...
class Program
{
    static string connectionString = "Server=(localdb)\\MSSQLLocalDB;Database=ProductManagement;Trusted_Connection=True;TrustServerCertificate=True;";
    ...
    static void InitializeDatabase()
    {
        try
        {
            ...
            using (var connection = new SqlConnection(masterConnection))
            {
                ...
                var checkDb = new SqlCommand("SELECT database_id FROM sys.databases WHERE Name = 'ProductManagement'", connection);
                var result = checkDb.ExecuteScalar();

                if (result == null)
                {
                    Console.WriteLine("Setting up database for first time...");
                    var createDb = new SqlCommand("CREATE DATABASE ProductManagement", connection);
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                var checkTable = new SqlCommand(@"
                    ...
                    WHERE TABLE_NAME = 'Products'", connection);
                var tableExists = checkTable.ExecuteScalar();
